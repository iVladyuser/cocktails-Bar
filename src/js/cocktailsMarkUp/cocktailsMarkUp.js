...
//<li>${isFav(item._id)}</li>
// export function isFav(id) {
//   if (favorites && !favorites.includes(id)) {
//     return `<button class="button-svg-heart" id="${id}" data-type="user-action" data-action="addfavorite">
//             <svg
//             class="icon-heart"
//             aria-label="icon-heart"
//             width="24"
...
//             </svg></button>`;
//   } else {
//     return `<button class="button-svg-heart is-favorite" id="${id}" data-type="user-action" data-action="addfavorite">
//             <svg
//             class="icon-heart"
//             aria-label="icon-heart"
//             width="24"
