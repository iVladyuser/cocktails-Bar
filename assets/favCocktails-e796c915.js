import"./styles-d91bea37.js";const e="favoriteCocktails",r=document.querySelector(".add-to-favorite-coctail-list"),s=JSON.parse(localStorage.getItem(e))??[],c=(t,o)=>{const i=t.map(a=>`
