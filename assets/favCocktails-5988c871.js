import{c as v,f,a as u}from"./header-69b8a56e.js";const r="favoriteCocktails",i=document.querySelector(".add-to-favorite-coctail-list"),h=JSON.parse(localStorage.getItem(r))??[],d=async(t,o)=>{const c=t.map(e=>`
