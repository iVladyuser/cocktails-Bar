import{f as v}from"./header-feb6b5db.js";const f=document.querySelector(".modal"),a="favoriteIngredients",c=document.querySelector(".add-to-favorite-list"),u=JSON.parse(localStorage.getItem(a))??[],s=(o,t)=>{const r=o.map(e=>`
